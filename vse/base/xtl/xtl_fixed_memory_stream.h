...
namespace vse::xtl
{
    ...
    {
        using is = irastream<fixed_memory_block_access>;

    public:
        explicit fixed_memory_stream_ro(const void* ptr, size_t len) : is(fixed_memory_block_access(ptr, len)) { }
    ...
    {
        using ios = iorastream<fixed_memory_block_access>;

    public:
        explicit fixed_memory_stream_rw(void* ptr, size_t len) : ios(fixed_memory_block_access(ptr, len, true)) { }
